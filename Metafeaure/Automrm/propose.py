...
text_inputs = torch.cat([clip.tokenize(f"photos of {dataset0.classes[0]}, {dataset0.classes[1]}, {dataset0.classes[2]}, {dataset0.classes[3]}, {dataset0.classes[4]}.")]).to(device)
...
# Save the feature
with open(task_embbeding_path, 'wb') as f:
